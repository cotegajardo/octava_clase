...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li <?php if ($json_data['features'][$n]['properties']['mag'] >= 6){?> style="color:RGB(255, 16, 0);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5){ ?> style="color:RGB(108, 1, 254);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 4.5){ ?> style="color:RGB(255, 196, 5);" <?php }else{ ?> style="color:RGB(58, 206, 255);" <?php };?>>
